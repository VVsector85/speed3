...
#define ODOMETER_EEP_CELLS 19  //+1 (counting from zero)
#define BOUNCE_DELAY 1
#define MAX_PERIOD 250	//MAX_PERIOD*TIC*16us speed is considered to be zero if delay between Hall sensor triggering is longer
#define BRICK_1 105
#define BRICK_2 110
#define BRICK_3 115
#define BRICK_4 120
...
volatile uint16_t speedTimerPrecise = 0;
...
#define WHEEL_DIAMETER_MIN 0.3
#define WHEEL_DIAMETER_MAX 2.0
double degreesPerKmh;	//degrees per km/h
